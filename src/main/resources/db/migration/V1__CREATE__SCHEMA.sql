...
DROP TABLE IF EXISTS bank.public.USERS_MENUS;
...
CREATE TABLE bank.public.USERS_MENUS (
    USER_ID INTEGER,
    MENU_ID INTEGER,
    CONSTRAINT USERS_MENUS_USERS_FK FOREIGN KEY (USER_ID) REFERENCES bank.public.USERS(ID)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT USERS_MENUS_MENUS_FK FOREIGN KEY (MENU_ID) REFERENCES bank.public.MENUS(ID)
     ON UPDATE CASCADE ON DELETE CASCADE
);
